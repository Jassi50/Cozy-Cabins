...
<head>
	...
	<meta name="google-site-verification" content="ZwdiRI4KrusAc9-t8OhffAGXJLBtl5scUs4-9MxSG_k" />
...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'cozy-cabins' ); ?></a>
	<header id="masthead" class="site-header">
		...
		<div class="site-branding">
			...
			$cozy_cabins_description = get_bloginfo( 'description', 'display' );
			if ( $cozy_cabins_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $cozy_cabins_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
